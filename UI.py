  ...
  "cells": [
    ...
    },
    {
      ...
      "metadata": {
        ...
        "id": "T7VRvHNYd2yl",
        "outputId": "9ad3d92c-56b8-4b5d-cc62-c69ad820708f"
      },
      "outputs": [
        {
          "output_type": "stream",
    ...
    },
    {
      ...
      "source": [
        ...
        "\n",
        "# Assuming you want to show items from the first column\n",
        "items = df[df.columns[6]].tolist()\n",
        "\n",
        "# Create a dropdown widget\n",
        "dropdown = widgets.Dropdown(\n",
        "    options=items,\n",
        "    value=items[0],  # Set default value\n",
        "    description='Select Item:',\n",
        ")\n",
        "\n",
        "# Function to show the selected item\n",
        "def show_selection(change):\n",
        "    print(f\"Selected item: {change['new']}\")\n",
        "\n",
        "# Attach the function to the dropdown\n",
        "dropdown.observe(show_selection, names='value')\n",
        "\n",
      ...
      "outputs": [
        {
          ...
          "data": {
            "text/plain": [
              "Dropdown(description='Select Item:', options=('Avatar', \"Pirates of the Caribbean: At World's End\", 'Spectre',…"
            ],
